...
import {
  ...
  ChevronLeft, ChevronRight, QrCode, X
} from 'lucide-react';
    ...
    <>
      ...
      <div className="relative z-10 flex flex-col h-full overflow-hidden">
        ...
        <nav className="flex flex-col overflow-y-auto overflow-x-hidden flex-1 mb-6 gap-1 custom-scrollbar pr-1">
          ...
          {/* Exams / materials / audit log are hidden for Admin by request; other roles unchanged */}
          {(isTeacher || isStudent) && renderButton('exams', <FileText size={20}/>, 'විභාග සහ ලකුණු')}
          
          {role !== 'Parent' && !isAdmin && renderButton('materials', <FileText size={20}/>, 'ඉගෙනුම් ද්‍රව්‍ය')}
